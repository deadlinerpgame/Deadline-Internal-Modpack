ISQuadTileFurniture = ISDoubleTileFurniture:derive("ISQuadTileFurniture")
...
function ISQuadTileFurniture:new(name, spriteLayout)
	local o = {}
	setmetatable(o, self)
	self.__index = self
	o:init()
	...
	o:setSprite(spriteLayout.north[4])
	o.buildLow = true
...
function ISQuadTileFurniture:getDirection()
...
function ISQuadTileFurniture:getAllSprites()
	local dir = self:getDirection()
	return self.sprites[dir:lower()]
end

function ISQuadTileFurniture:getOffsets(x, y, z)
	local dir = self:getDirection()
