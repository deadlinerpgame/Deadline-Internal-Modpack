...
DiceTraits.gunRangeByClass = { pistol = "medium", shotgun = "close", rifle = "long", crossbow = "long" }
...
local GUN_CLASSES = { pistol = true, shotgun = true, rifle = true, crossbow = true }
local RANGED_CLASSES = { pistol = true, shotgun = true, rifle = true, crossbow = true, thrown = true, molotov = true, bomb = true }
