...
Events.onAddForageDefs.Add(function()
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=0.05, Vegitation=0.03, FarmLand=0.03, Farm=0.03, TrailerPark=0,	TownZone=0, Nav=0},
...
local Pig = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=0.03, Vegitation=0.03, FarmLand=0.05, Farm=0.05, TrailerPark=0,	TownZone=0, Nav=0},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local Black_cat = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=0.03, Vegitation=0.03, FarmLand=0.03, Farm=0.05, TrailerPark=0.03, TownZone=0.05, Nav=0.030},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local F_Hen = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=0.03, Vegitation=0.03, FarmLand=0.05, Farm=0.05, TrailerPark=0.03, TownZone=0, Nav=0},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local German_shepard = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=0.03, Vegitation=0.03, FarmLand=0.03, Farm=0.05, TrailerPark=0.03, TownZone=0.05, Nav=0.03},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local F_Bunny_01 = {
	...
	xp = 2,
	categories = { "Animals" },
	zones = {Forest=0.03, Vegitation=0.03, FarmLand=0.03, Farm=0.05, TrailerPark=0.03, TownZone=0, Nav=0.03},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local F_Skunk = {
	...
	xp = 2,
	categories = { "Animals" },
	zones = {Forest=0.05, Vegitation=0.05, FarmLand=0.03, Farm=0.03, TrailerPark=0.03, TownZone=0, Nav=0.03},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
