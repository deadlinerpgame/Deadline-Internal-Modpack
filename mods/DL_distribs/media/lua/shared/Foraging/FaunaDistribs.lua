...
Events.onAddForageDefs.Add(function()
    ...
    local Armadillo = {
		...
		dayChance = -50,
		categories = { "Animals" },
		zones = {Forest=0.2, Vegitation=0.2, FarmLand=0.2, Farm=0.2, TrailerPark=0,	TownZone=0, Nav=0},
	...
	local Pig = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0.2, Vegitation=0.2, FarmLand=0.2, Farm=2, TrailerPark=0,	TownZone=0, Nav=0},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local Black_cat = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0.2, Vegitation=0.2, FarmLand=0.6, Farm=0.2, TrailerPark=0.2, TownZone=0.2, Nav=0.6},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local F_Hen = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0.2, Vegitation=0.2, FarmLand=2, Farm=2, TrailerPark=0.2, TownZone=0, Nav=0},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local F_Cow_f_bw = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0, Vegitation=0.2, FarmLand=0.2, Farm=0.2, TrailerPark=0.2, TownZone=0, Nav=0},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local F_Horse = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0.2, Vegitation=0.2, FarmLand=0.2, Farm=0.2, TrailerPark=0.2, TownZone=0, Nav=0},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local German_shepard = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0.2, Vegitation=0.2, FarmLand=0.2, Farm=0.2, TrailerPark=0.2, TownZone=0.2, Nav=1},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local F_Bunny_01 = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0.2, Vegitation=0.2, FarmLand=0.2, Farm=0.2, TrailerPark=0.2, TownZone=0, Nav=1},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
