...
Events.onAddForageDefs.Add(function()
	...
	local Pig = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=1, Vegitation=1, FarmLand=1, Farm=2, TrailerPark=0,	TownZone=0, Nav=0},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local Black_cat = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=1, Vegitation=1, FarmLand=3, Farm=1, TrailerPark=1, TownZone=1, Nav=3},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
	...
	local F_Cow_f_bw = {
        ...
        rainChance = -10,
		categories = { "Animals" },
		zones = {Forest=0, Vegitation=1, FarmLand=1, Farm=1, TrailerPark=1, TownZone=0, Nav=0},
		spawnFuncs = { doGenericItemSpawn },
		forceOutside = false,
		canBeAboveFloor = true,
		itemSizeModifier = 0.5,
