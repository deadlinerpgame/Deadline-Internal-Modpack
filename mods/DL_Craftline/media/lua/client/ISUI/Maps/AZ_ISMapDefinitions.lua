...
LootMaps.Init.Runics_Map = function(mapUI)

	local mapAPI = mapUI.javaObject:getAPIv1()
	MapUtils.initDirectoryMapData(mapUI, 'media/maps/Muldraugh, KY')
	mapAPI:setBoundsInSquares(10510, 9000, 12990, 10480)
	overlayPNG(mapUI, 10494, 8982, 1.0, "lootMapPNG", "media/ui/LootableMaps/RunicMap.png", 1.0)
