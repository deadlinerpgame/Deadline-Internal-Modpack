...
Events.onAddForageDefs.Add(function()
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=2, Vegitation=1, FarmLand=1, Farm=1, TrailerPark=0,	TownZone=0, Nav=0},
...
local Pig = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=1, Vegitation=1, FarmLand=2, Farm=2, TrailerPark=0,	TownZone=0, Nav=0},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local Black_cat = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=1, Vegitation=1, FarmLand=1, Farm=2, TrailerPark=1, TownZone=2, Nav=10},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local F_Hen = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=1, Vegitation=1, FarmLand=2, Farm=2, TrailerPark=1, TownZone=0, Nav=0},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local German_shepard = {
	...
	xp = 20,
	categories = { "Animals" },
	zones = {Forest=1, Vegitation=1, FarmLand=1, Farm=2, TrailerPark=1, TownZone=2, Nav=1},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local F_Bunny_01 = {
	...
	xp = 2,
	categories = { "Animals" },
	zones = {Forest=1, Vegitation=1, FarmLand=1, Farm=2, TrailerPark=1, TownZone=0, Nav=1},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
...
local F_Skunk = {
	...
	xp = 2,
	categories = { "Animals" },
	zones = {Forest=2, Vegitation=2, FarmLand=1, Farm=1, TrailerPark=1, TownZone=0, Nav=1},
	spawnFuncs = { doGenericItemSpawn },
	forceOutside = false,
	canBeAboveFloor = true,
	itemSizeModifier = 0.5,
