...
function ISTradingUIHistorical:prerender()
    ...
    self:drawText(getText("IGUI_ISTradingUIHistorical_Title", self.otherPlayer:getDescriptor():getForename()), self.width/2 - (getTextManager():MeasureStringX(UIFont.Medium, getText("IGUI_ISTradingUIHistorical_Title")) / 2), z, 1,1,1,1, UIFont.Medium);
end
