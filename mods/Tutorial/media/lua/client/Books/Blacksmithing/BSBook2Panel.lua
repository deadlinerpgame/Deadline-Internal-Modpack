...
BSBook2Panel = ISPanel:derive("BSBook2Panel");
...
function BSBook2Panel:initialise()
...
--**
--************************************************************************--
function BSBook2Panel:createChildren()
	...
	local previousButton = ISButton:new(3, (panel2.height / 2), 20, 20, "", self, BSBook2Panel.previousPage);
	...
	local nextButton = ISButton:new(24, (panel2.height / 2), 20, 20, "", self, BSBook2Panel.nextPage);
	...
	local closeButton = ISButton:new(self.width - 23, (panel2.height / 2), 20, 20, "", self, BSBook2Panel.closePage);
    ...
    local moreInfo = ISButton:new(closeButton:getX() - buttonWid - 1, (panel2.height / 2), buttonWid, 20, getText("IGUI_Tutorial_MoreInfo"), self, BSBook2Panel.moreInfo);
...
function BSBook2Panel:reloadBtns()
...
function BSBook2Panel:previousPage(button)
...
function BSBook2Panel:closePage(button)
...
--************************************************************************--
--** BSBook2Panel:nextPage
--**
--************************************************************************--
function BSBook2Panel:nextPage(button)
    self.tutorialSetInfo.currentPage = self.tutorialSetInfo.currentPage + 1;
    self.tutorialSetInfo:applyPageToRichTextPanel(self.richtext);
	if self.moreinfo == nil then
       self:initMoreInfoPanel();
...
function BSBook2Panel:initMoreInfoPanel()
...
function BSBook2Panel:moreInfo(button)
    if self.moreinfo == nil then
       self:initMoreInfoPanel();
    else
		if self.moreinfo:getIsVisible() then
...
--**
--************************************************************************--
function BSBook2Panel:prerender()
...
--**
--************************************************************************--
function BSBook2Panel:new (x, y, width, height)
	local o = {}
	--o.data = {}
