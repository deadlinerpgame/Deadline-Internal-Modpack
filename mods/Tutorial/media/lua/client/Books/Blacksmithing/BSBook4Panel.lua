...
BSBook4Panel = ISPanel:derive("BSBook4Panel");
...
function BSBook4Panel:initialise()
...
--**
--************************************************************************--
function BSBook4Panel:createChildren()
	...
	local previousButton = ISButton:new(3, (panel2.height / 2), 20, 20, "", self, BSBook4Panel.previousPage);
	...
	local nextButton = ISButton:new(24, (panel2.height / 2), 20, 20, "", self, BSBook4Panel.nextPage);
	...
	local closeButton = ISButton:new(self.width - 23, (panel2.height / 2), 20, 20, "", self, BSBook4Panel.closePage);
    ...
    local moreInfo = ISButton:new(closeButton:getX() - buttonWid - 1, (panel2.height / 2), buttonWid, 20, getText("IGUI_Tutorial_MoreInfo"), self, BSBook4Panel.moreInfo);
...
function BSBook4Panel:reloadBtns()
...
function BSBook4Panel:previousPage(button)
...
function BSBook4Panel:closePage(button)
...
--************************************************************************--
--** BSBook4Panel:nextPage
--**
--************************************************************************--
function BSBook4Panel:nextPage(button)
    self.tutorialSetInfo.currentPage = self.tutorialSetInfo.currentPage + 1;
    self.tutorialSetInfo:applyPageToRichTextPanel(self.richtext);
	if self.moreinfo == nil then
       self:initMoreInfoPanel();
...
function BSBook4Panel:initMoreInfoPanel()
...
function BSBook4Panel:moreInfo(button)
    if self.moreinfo == nil then
       self:initMoreInfoPanel();
    else
		if self.moreinfo:getIsVisible() then
...
--**
--************************************************************************--
function BSBook4Panel:prerender()
...
--**
--************************************************************************--
function BSBook4Panel:new (x, y, width, height)
	local o = {}
	--o.data = {}
