...
BSBook3Panel = ISPanel:derive("BSBook3Panel");
...
function BSBook3Panel:initialise()
...
--**
--************************************************************************--
function BSBook3Panel:createChildren()
	...
	local previousButton = ISButton:new(3, (panel2.height / 2), 20, 20, "", self, BSBook3Panel.previousPage);
	...
	local nextButton = ISButton:new(24, (panel2.height / 2), 20, 20, "", self, BSBook3Panel.nextPage);
	...
	local closeButton = ISButton:new(self.width - 23, (panel2.height / 2), 20, 20, "", self, BSBook3Panel.closePage);
    ...
    local moreInfo = ISButton:new(closeButton:getX() - buttonWid - 1, (panel2.height / 2), buttonWid, 20, getText("IGUI_Tutorial_MoreInfo"), self, BSBook3Panel.moreInfo);
...
function BSBook3Panel:reloadBtns()
...
function BSBook3Panel:previousPage(button)
...
function BSBook3Panel:closePage(button)
...
--************************************************************************--
--** BSBook3Panel:nextPage
--**
--************************************************************************--
function BSBook3Panel:nextPage(button)
    self.tutorialSetInfo.currentPage = self.tutorialSetInfo.currentPage + 1;
    self.tutorialSetInfo:applyPageToRichTextPanel(self.richtext);
	if self.moreinfo == nil then
       self:initMoreInfoPanel();
...
function BSBook3Panel:initMoreInfoPanel()
...
function BSBook3Panel:moreInfo(button)
    if self.moreinfo == nil then
       self:initMoreInfoPanel();
    else
		if self.moreinfo:getIsVisible() then
...
--**
--************************************************************************--
function BSBook3Panel:prerender()
...
--**
--************************************************************************--
function BSBook3Panel:new (x, y, width, height)
	local o = {}
	--o.data = {}
