...
BSBook5Panel = ISPanel:derive("BSBook5Panel");
...
function BSBook5Panel:initialise()
...
--**
--************************************************************************--
function BSBook5Panel:createChildren()
	...
	local previousButton = ISButton:new(3, (panel2.height / 2), 20, 20, "", self, BSBook5Panel.previousPage);
	...
	local nextButton = ISButton:new(24, (panel2.height / 2), 20, 20, "", self, BSBook5Panel.nextPage);
	...
	local closeButton = ISButton:new(self.width - 23, (panel2.height / 2), 20, 20, "", self, BSBook5Panel.closePage);
    ...
    local moreInfo = ISButton:new(closeButton:getX() - buttonWid - 1, (panel2.height / 2), buttonWid, 20, getText("IGUI_Tutorial_MoreInfo"), self, BSBook5Panel.moreInfo);
...
function BSBook5Panel:reloadBtns()
...
function BSBook5Panel:previousPage(button)
...
function BSBook5Panel:closePage(button)
...
--************************************************************************--
--** BSBook5Panel:nextPage
--**
--************************************************************************--
function BSBook5Panel:nextPage(button)
    self.tutorialSetInfo.currentPage = self.tutorialSetInfo.currentPage + 1;
    self.tutorialSetInfo:applyPageToRichTextPanel(self.richtext);
	self.moreinfo:setVisible(false);
	if self.moreinfo == nil then
...
function BSBook5Panel:initMoreInfoPanel()
...
function BSBook5Panel:moreInfo(button)
    if self.moreinfo == nil then
       self:initMoreInfoPanel();
    else
		if self.moreinfo:getIsVisible() then
...
--**
--************************************************************************--
function BSBook5Panel:prerender()
...
--**
--************************************************************************--
function BSBook5Panel:new (x, y, width, height)
	local o = {}
	--o.data = {}
	...
	o.prevBtnTxt = getTexture("");
	o.nextBtnTxt = getTexture("");
